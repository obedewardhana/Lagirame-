...
<div class="wrapper style1">
    <div class="container">
      ...
      <div class="row">  
            ...
            <h1 class="categories"><?php echo $typename['type'];?></h1> </div>
                  ...
                  foreach ($types as $tipe):
                    ...
                    <div class="card radius shadowDepth1">
                      <div class="card__image border-tlr-radius">
                        <img alt="image" class="border-tlr-radius" style="height:120px" src="data:image/jpeg;base64,<?php echo base64_encode($tipe->image); ?>" >
                      </div>
                      ...
                      <div class="card__content card__padding">
                        ...
                        <a class="card-body-header-category" href="<?php echo site_url('event/types/'.($tipe->type)) ?>"><?php echo $tipe->type;?></a>

                        
                          
                          <a href="<?php echo site_url('event/categories/'.($tipe->category_id)) ?>" class="card-body-header-category2" >
                          <?php $categoris=$this->category_model->get_paged_list()->result();
                                ...
                                echo $tipe->category_id=$result[$tipe->category_id];?>
                         ...
                         <p class="time"><label class="calendar">&nbsp;</label>
                          ...
                          $d = strtotime($tipe->start_date);
                          $format = '%d %B %Y';
                          echo strftime($format, $d);?></p>
                          <h2 class="feature"><a href="<?php echo site_url('event/eventdetails/'.($tipe->event_id)) ?>"><?php custom_echo($tipe->title, 40);?></a></h2>
                          <p class="location"><label class="lokasi">&nbsp;</label><?php custom_echo($tipe->location, 35);?></p>
                          <a  href="<?php echo site_url('event/eventdetails/'.($tipe->event_id)) ?>">Click Details&nbsp;<label class="next"></label></a>
                        ...
                        endforeach;
                          ...
                          echo " <td colspan=50></br>Tidak Ada Event.</br> </br></tr></td></br></br></br><tr>";
                        }
                        ?> 
