...
<div class="row">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo site_url('admin/users/update_user_umum/'.$users->user_id)?>">Edit <?=$users->name?></a></li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Edit User Umum</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<?php echo form_open_multipart('admin/users/update_user_umum/'.$users->user_id); ?>
